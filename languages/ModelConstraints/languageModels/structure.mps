...
<model ref="r:c379e502-b565-4052-bf15-b57b9592fda0(GenericGroupMethods.structure)">
  ...
  <node concept="1TIwiD" id="1CbK6AejRJj">
    ...
    <node concept="1TJgyj" id="1QzqmUpCW7q" role="1TKVEi">
      <property role="20lmBu" value="aggregation" />
      <property role="20kJfa" value="varRef" />
      <property role="20lbJX" value="1" />
      <ref role="20lvS9" to="tpee:fz7vLUo" resolve="VariableReference" />
  ...
  <node concept="1TIwiD" id="1glZBhirKrr">
    <property role="TrG5h" value="MethodsContainerDocComment" />
    <property role="3GE5qa" value="Documentation" />
    <ref role="1TJDcQ" to="m373:4CW56HZFIGO" resolve="MethodDocComment" />
    <node concept="M6xJ_" id="1glZBhirKPG" role="lGtFl">
      <property role="Hh88m" value="methodsContainerDoc" />
  ...
  <node concept="1TIwiD" id="vvAecQsslV">
    <property role="3GE5qa" value="Operations.OperationsOnConceptType" />
    <property role="TrG5h" value="copy" />
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="PrWs8" id="vvAecQssoa" role="PzmwI">
      <ref role="PrY4T" to="tpee:hqOqG0K" resolve="IOperation" />
    </node>
    <node concept="1TJgyj" id="vvAecQsyID" role="1TKVEi">
      <property role="20lmBu" value="aggregation" />
