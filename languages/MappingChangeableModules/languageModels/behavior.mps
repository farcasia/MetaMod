...
<model ref="r:d7b81ddf-e7b4-4aad-b4ef-1edcac8b0b8f(MappingChangeableModules.behavior)">
  ...
  <node concept="13h7C7" id="2viqW8D$y3S">
    <ref role="13h7C2" to="5h42:2viqW8D$wQc" resolve="TransformationCall" />
    ...
    <node concept="13hLZK" id="2viqW8D$y3T" role="13h7CW">
      <node concept="3clFbS" id="2viqW8D$y3U" role="2VODD2" />
    </node>
  </node>
</model>
