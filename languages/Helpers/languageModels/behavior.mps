...
<model ref="r:0282a494-ac4a-4a3a-8302-c9ef8ee9514a(Helpers.behavior)">
  ...
  <node concept="13h7C7" id="4L1k0Soa$cw">
    <ref role="13h7C2" to="leqx:4L1k0Soa314" resolve="HelperMethodCall" />
    ...
    <node concept="13hLZK" id="4L1k0Soa$cx" role="13h7CW">
      <node concept="3clFbS" id="4L1k0Soa$cy" role="2VODD2" />
    </node>
  </node>
</model>
