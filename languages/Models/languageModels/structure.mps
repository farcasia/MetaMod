...
<model ref="r:86a4248e-5c5f-4e5d-95f9-ca709673f402(Models.structure)">
  ...
  <node concept="1TIwiD" id="VQwemtBHQ2">
    ...
    <node concept="PrWs8" id="5kU4o$sRl3_" role="PzmwI">
  ...
  <node concept="1TIwiD" id="6iY9Pwzxd4">
    ...
    <ref role="1TJDcQ" to="tpck:gw2VY9q" resolve="BaseConcept" />
    <node concept="1TJgyj" id="6iY9P$yC61" role="1TKVEi">
      <property role="20lmBu" value="aggregation" />
      <property role="20kJfa" value="allGroups" />
      <property role="20lbJX" value="0..n" />
      <ref role="20lvS9" node="7zWtwVwpdAi" resolve="RefToNamedGroup" />
    </node>
