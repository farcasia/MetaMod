...
<model ref="r:b4b1c2a0-fbd5-4bac-a5d1-bc2c5145afb0(GroupInterfaces.editor)">
  ...
  <node concept="24kQdi" id="4Gz6IvJ9v3H">
    ...
    <node concept="3EZMnI" id="4Gz6IvJ9v3J" role="2wV5jI">
      ...
      <node concept="3F0A7n" id="4ilUKiYEUwS" role="3EZMnx">
      ...
      <node concept="3F2HdR" id="4Gz6IvJ9vf$" role="3EZMnx">
        ...
        <node concept="4$FPG" id="4ilUKiYFrI6" role="4_6I_">
          <node concept="3clFbS" id="4ilUKiYFrI7" role="2VODD2">
            <node concept="3cpWs6" id="4ilUKiYFsA$" role="3cqZAp">
              <node concept="2ShNRf" id="4ilUKiYFsBo" role="3cqZAk">
                <node concept="3zrR0B" id="4ilUKiYFvSC" role="2ShVmc">
                  <node concept="3Tqbb2" id="4ilUKiYFvSE" role="3zrR0E">
                    <ref role="ehGHo" to="xxun:4ilUKiYFflW" resolve="EmptyLine" />
                  </node>
                </node>
              </node>
            </node>
  ...
  <node concept="24kQdi" id="4ilUKiYFrGS">
    <ref role="1XX52x" to="xxun:4ilUKiYFflW" resolve="EmptyLine" />
    <node concept="3F0ifn" id="4ilUKiYFrGU" role="2wV5jI">
      <node concept="OXEIz" id="4ilUKiYFrGX" role="P5bDN">
        <node concept="UkePV" id="4ilUKiYFrGZ" role="OY2wv">
          <ref role="Ul1FP" to="xxun:4Gz6IvJaKb6" resolve="MethodSignature" />
        </node>
      </node>
    </node>
  </node>
